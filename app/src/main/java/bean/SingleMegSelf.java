...
public class SingleMegSelf {
    ...
    public static SingleMegSelf getSingleMegSelf(String username, String nick, String motto, String email, String school,
        ...
        if(singleMegSelf==null){
            singleMegSelf = new SingleMegSelf(username, nick, motto, email, school, gender, acb, submitnum, acnum, ratingnum, rating);
        }
    ...
    public static SingleMegSelf getSingleMegSelf(){
        if(singleMegSelf==null){
            ...
            thread.start();*/
            singleMegSelf = new SingleMegSelf("username", "nick", "motto", "email", "school", 1, 0, 0, 0, 0, 0);
        }
        return singleMegSelf;
    }
    ...
    private static void  AxJSON(String s){
        try {
            ...
            if(MYURL.SUCCESS.equals(ret)){
                ...
                singleMegSelf = SingleMegSelf.getSingleMegSelf(username,nick,motto,email,school,gender,acb,submitnum,acnum,ratingnum,rating);
